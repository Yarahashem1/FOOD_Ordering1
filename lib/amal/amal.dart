...
class _CategoryState extends State<Category> {
  ...
  Future deleteFavourite1(int i) async {
    return await FirebaseFirestore.instance.collection('favorite')
                                         ...
                                         children: [
                                           ...
                                           StreamBuilder(
                                             stream: FirebaseFirestore.instance.collection("favorite").doc(FirebaseAuth.instance.currentUser!.email)
                                                 .collection("items").where("name",isEqualTo: items[index]['name']).snapshots(),
                                             builder: (BuildContext context, AsyncSnapshot snapshot){
                                               ...
                                               return Padding(
                                                 ...
                                                 child: CircleAvatar(
                                                   ...
                                                   child: IconButton(
                                                     onPressed: () {
                                                         snapshot.data.docs.length==0?addToFavourite(index):deleteFavourite1(index);
                                                     },
